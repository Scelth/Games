...
int main()
{
	...
	Texture t;
	t.loadFromFile("D:/Downloads/Дипломная/Дипломная/title.png");
	Sprite plat(t);

	Texture yw;
	yw.loadFromFile("D:/Downloads/Дипломная/Дипломная/youwin.png");
	Sprite youwin(yw);
	youwin.setPosition(100, 210);

	Texture yl;
	yl.loadFromFile("D:/Downloads/Дипломная/Дипломная/youlose.png");
	Sprite youlose(yl);
